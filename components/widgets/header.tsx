            ...
            <div className="container mx-auto flex items-center justify-between p-5 lg:py-5 lg:px-0">
                ...
                <section>
                    <ul className="hidden lg:flex items-center gap-x-8">
                        <li>
                            <Link href="/" className="relative text-white  transition-colors duration-300 before:absolute before:left-0 before:-bottom-2 before:w-full before:h-0.5 before:bg-white before:rounded-full before:transition-all before:duration-300">Inicio
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link href="/" className="relative text-white  transition-colors duration-300 before:absolute before:left-0 before:-bottom-2 before:w-0 before:h-0.5 before:bg-white before:rounded-full before:transition-all before:duration-300 hover:before:w-full">Contacto
                            </Link>
                        </li>
                    </ul>
