...
export const SliderThumbnailItem = ({
    ...
    onClick,
        ...
        return( <li role= "buttom" onClick={onClick} className={cn("h-[250px] shrink-0 transition-all duration-300 overflow-hidden relative after:absolute after:w-full after::h-full after:left-0 after:bottom-0 after:bg-thumbnails hover:brightness-150", 
        itemActive ===id 
